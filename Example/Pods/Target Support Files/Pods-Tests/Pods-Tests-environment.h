...
// ExcelKit
#define COCOAPODS_POD_AVAILABLE_ExcelKit
#define COCOAPODS_VERSION_MAJOR_ExcelKit 0
#define COCOAPODS_VERSION_MINOR_ExcelKit 1
#define COCOAPODS_VERSION_PATCH_ExcelKit 0
